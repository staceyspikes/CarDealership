...
namespace CarDealership.Controllers
{
    public class BuyersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BuyerID,FirstName,LastName,LicenseNumber,PhoneNumber")] Buyer buyer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BuyerID,FirstName,LastName,LicenseNumber,PhoneNumber")] Buyer buyer)
        {
            if (ModelState.IsValid)
            {
